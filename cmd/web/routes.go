...
func (app *application) routes() http.Handler {
	...
	router.Get("/post/create", app.loadAndSaveSession(app.createPostForm))
	router.Post("/post/create", app.loadAndSaveSession(app.CreatePost))
	...
	router.Post("/post/logout", app.loadAndSaveSession(app.userLogoutPost))
